...
public class AccelerationLimits {
    ...
    public static final double G = 386.09; // Acceleration of gravity in inches/second/second.0

    public AccelerationLimits(double accelerationG, double decelerationG, DriveChassisIF chassis, AnalogSettings settings) {
